...
namespace WebClient.UserControls
{
    ...
    public partial class EmployeeDetailsFormView : MvpUserControl<EmployeeDetailsViewModel>, IEmployeeDetailsView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(Request.Params["Id"], out id))
            {
                ...
                this.EmployeeDetails.DataSource = this.Model.Employees;
